...
The embedded image definition installs third-party software from a Flox base
image and a pinned Nixpkgs revision. Those packages remain subject to their own
licenses, notices, and terms; coop's Apache-2.0 license does not replace them.
